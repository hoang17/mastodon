...
export const alink = [
  <NavLink className='tabs-bar__link secondary' exact to='/timelines/public' data-preview-title-id='column.public' data-preview-icon='globe' ><i className='fa fa-fw fa-globe' />
    {/* Global */}
    <FormattedMessage id='tabs_bar.federated_timeline' defaultMessage='Federated' />
  </NavLink>,
];
...
export function getIndex (path) {
  return alink.findIndex(link => link.props.to === path);
}

export function getLink (index) {
  return alink[index].props.to;
}
